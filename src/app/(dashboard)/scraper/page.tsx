      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/5 pb-6">
        <div>
          <div className="flex items-center gap-2.5">
            <h1 className="text-2xl font-bold text-white tracking-tight">NexScraper Engine v4.0</h1>
            <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-cyan-500/10 text-cyan-400 border border-cyan-500/30 uppercase tracking-wide">
              Targeted Sources
            </span>
          </div>
                ...
                >
                  ...
                  <div className="space-y-1.5 text-xs text-slate-400 mb-4">
                    <div className="flex items-center gap-2 truncate">
                      ...
                      <span className="text-slate-200 select-all">{lead.email}</span>
                    </div>
                    {lead.phone && (
                      <div className="flex items-center gap-2 truncate">
